...
class Transaction extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->ckeditor->basePath = base_url().'assets/adm/ckeditor/';
  ...
  //               array('Bold','Italic','Underline','Strike','Subscript','Superscript')
	...
	public function penyewaan()
	{
		...
		$data['content'] = $this->load->view('adm/transaction/listsewa',$data, TRUE);
	...
	public function settingKeterangan()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['notif'] = $this->Admin_model->getNotifikasi();
			$data['content'] = $this->load->view('adm/element/settingketerangan',$data, TRUE);
			$this->load->view('adm/element/main', $data);
		}
	}
	...
	public function pengembalian()
	{
		...
		$data['notif'] = $this->Admin_model->getNotifikasi();
		$data['content'] = $this->load->view('adm/transaction/listkembali',$data, TRUE);
		$this->load->view('adm/element/main', $data);
	}
	...
	public function kembalikanMobil()
	{
		...
		$data['notif'] = $this->Admin_model->getNotifikasi();
		$data['content'] = $this->load->view('adm/transaction/listpengembalian',$data, TRUE);
		$this->load->view('adm/element/main', $data);
	}
